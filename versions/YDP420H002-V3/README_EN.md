...
Current module version: **YDP420H002-V3**. Electrical and mechanical details follow [`docs/YDP420H002-V3.pdf`](./docs/YDP420H002-V3.pdf).
...
└── versions/
    └── YDP420H002-V3/                      # full materials for this part number
        ├── README.md
        ├── README_EN.md
        ├── images/
        ├── docs/
...
| Resource | Link |
| ---- | ---- |
| Product datasheet (YDP420H002-V3) | [`docs/YDP420H002-V3.pdf`](./docs/YDP420H002-V3.pdf) |
