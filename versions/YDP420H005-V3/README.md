...
<p align="center"><img alt="OSPTEK 4.2 寸 300×400 LCD SPI 模组（ST7306）宣传图" src="./images/product.png" width="640" /></p>
...
当前模组版本：**YDP420H005-V3**。电气与外形细节以 [`docs/YDP420H005-V3.pdf`](./docs/YDP420H005-V3.pdf) 为准。
...
| 资料 | 链接 |
| ---- | ---- |
| 产品规格书（YDP420H005-V3） | [`docs/YDP420H005-V3.pdf`](./docs/YDP420H005-V3.pdf) |
